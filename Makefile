...
IMG ?= ghcr.io/sf1tzp/databasus-operator:latest
...
KIND_CLUSTER ?= databasus-operator-test-e2e
...
docker-buildx: ## Build and push docker image for the manager for cross-platform support
	...
	- $(CONTAINER_TOOL) buildx create --name databasus-operator-builder
	$(CONTAINER_TOOL) buildx use databasus-operator-builder
	- $(CONTAINER_TOOL) buildx build --push --platform=$(PLATFORMS) --tag ${IMG} -f Dockerfile.cross .
	- $(CONTAINER_TOOL) buildx rm databasus-operator-builder
	rm Dockerfile.cross
